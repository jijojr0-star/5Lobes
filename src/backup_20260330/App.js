    ...
    return (
        <ModalProvider>
            <div className="min-h-screen">
                ...
                {/* Scroll-to-top button — stacks above WhatsApp */}
                <button
                    onClick={scrollToTop}
                    aria-label="Scroll to top"
                    className={[
                        "fixed bottom-24 right-6 z-50 w-11 h-11 rounded-full",
                        "bg-[#0a192f] border border-white/10 text-white",
                        "flex items-center justify-center shadow-lg",
                        "hover:bg-[#007bff] hover:border-transparent hover:scale-110",
                ...
                <a
                    href="https://wa.me/916383393896?text=Hello%20I%20am%20interested%20in%20your%20services"
                    target="_blank"
