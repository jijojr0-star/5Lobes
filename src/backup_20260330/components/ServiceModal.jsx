    ...
    return (
        ...
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="max-w-6xl w-[90vw] max-h-[90vh] overflow-hidden p-0">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 overflow-y-auto max-h-[90vh] min-h-[420px]">
                        ...
                        {service.partnership && (
                            <div className="bg-accent/50 border border-primary/20 rounded-lg p-5 mb-6">
                                <div className="flex items-center gap-2 mb-2">
                                    ...
                                    <span className="text-lg font-bold text-secondary uppercase tracking-wide">
                                        Partnership
                                    </span>
                                </div>
